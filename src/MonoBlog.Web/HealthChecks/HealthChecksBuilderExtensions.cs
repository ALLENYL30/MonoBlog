...
namespace MonoBlog.Web.HealthChecks;

public static class HealthChecksBuilderExtensions
{
    public static void AddMonoBlogHealthChecks(this IServiceCollection services)
    {
        // Add your health checks here
        var healthChecksBuilder = services.AddHealthChecks();
        healthChecksBuilder.AddCheck<MonoBlogDatabaseCheck>("MonoBlog DbContext Check",
        ...
        {
            settings.AddHealthCheckEndpoint("MonoBlog Health Status", healthCheckUrl);
        });
